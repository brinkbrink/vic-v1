...
<div>	
    <label>
        ...
        <select name="How_Did_You_Get_Here?" required="required" title="How You Heard is required" tabindex="30">
...
<div>	
    <fieldset>
        ...
        <input type="checkbox" name="Interested_In[]" value="Free Virtual Hugs" /> Free Virtual Hugs <br />
